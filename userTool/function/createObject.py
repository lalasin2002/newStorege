...
class jointInserter():
    ...
    사용 순서 (조인트 끼워넣기):
        ...
        2. calculateVector  - 끼울 위치 및 segment 계산
        3. printData        - (선택) 디버그 출력
        4. createInsertJnt  - 조인트 생성 및 hierarchy 재구성
        5. orientJnt        - (선택) 방향 정렬
    ...
    def __init__(self, startJnt, endJnt):
        """
