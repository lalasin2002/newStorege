...
ext = Extension(
    ...
    # 3.7 :: r"C:\Program Files\Autodesk\Maya2022\devkitBase\include\Python37\Python"
    # 3.11 :: r"C:\Program Files\Autodesk\Maya2025\include\Python311"
    

    ### library_dirs
    #.2.7 :: r"C:\Program Files\Autodesk\Maya2020\lib"
    # 3.7 :: r"C:\Program Files\Autodesk\Maya2022\devkitBase\lib"
    ...
    include_dirs=[
        ...
        r"C:\Program Files\Autodesk\Maya2022\devkitBase\include\Python37\Python"
    ],

    library_dirs=[
        # python27.lib 위치
        # 링커가 Python API 심볼(PyObject 등)을 연결할 때 필요
        r"C:\Program Files\Autodesk\Maya2022\devkitBase\lib"
    ],
