...
REM ------------------------------------------------------------
REM Maya 2022 Python 3.7용 .pyd 빌드 배치
REM ------------------------------------------------------------

REM [수정됨] 직접 확인하신 Community 경로 적용
...
REM [핵심] 마야 2022 내장 파이썬 경로 적용
set PYTHON_PATH="C:\Program Files\Autodesk\Maya2022\bin\mayapy.exe"
