...
set "MAYAPY_PATH=C:\Program Files\Autodesk\Maya2026\bin\mayapy.exe"
set "LAUNCHER_SCRIPT=%~dp0run.py"

if not exist "%MAYAPY_PATH%" (
    echo [ERROR] Maya 2026 mayapy.exe was not found:
    echo "%MAYAPY_PATH%"
    pause
    exit /b 1
)
...
echo Starting StandOuterTool for Maya 2026...
